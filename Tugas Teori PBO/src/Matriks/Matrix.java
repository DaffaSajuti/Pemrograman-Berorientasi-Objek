...
public class Matrix {
    ...
    public Matriks.Matrix tambah(Matriks.Matrix other) {
        if (this.baris != other.baris || this.kolom != other.kolom) {
            System.out.println("Ukuran matriks tidak sesuai");
            return null;
        }
        Matriks.Matrix hasil = new Matriks.Matrix(this.baris, this.kolom);
    ...
    public Matriks.Matrix kurang(Matriks.Matrix other) {
        if (this.baris != other.baris || this.kolom != other.kolom) {
            System.out.println("Ukuran matriks tidak sesuai");
            return null;
        }
    ...
    public Pecahan dotProduct(Matriks.Matrix other, int barisKedua) {
    ...
    public Matriks.Matrix transpose() {
        Matriks.Matrix hasil = new Matriks.Matrix(kolom, baris);
        for (int i = 0; i < baris; i++) {
            for (int j = 0; j < kolom; j++) {
